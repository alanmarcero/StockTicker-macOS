...
final class VIXSpikeCacheTests: XCTestCase {
    ...
    func testReplaceSpikesAndClearIfChanged_datesChanged_clearsPrices() async {
        let mockFS = MockFileSystem()
    ...
    func testReplaceSpikesAndClearIfChanged_newSpikeAdded_clearsPrices() async {
        let mockFS = MockFileSystem()
        ...
        // New spike detected (live spike starting)
    ...
    func testClearForDailyRefresh_clearsSymbolPricesKeepsSpikes() async {
        let mockFS = MockFileSystem()
